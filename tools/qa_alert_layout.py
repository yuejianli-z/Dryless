...
def geometry():
    targets=[w.titlebar,w.stack,w.monitor.camera,w.monitor.metrics,w.monitor.trend,w.sidebar.alert_host,w.sidebar._face_label,w.sidebar._session_lbl,*w.sidebar._buttons.values()]
